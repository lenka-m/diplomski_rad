...
function NewUser({ setAllUsers }) {
  ...
  const handleChange = (e) => {
    ...
    } else if (e.target.name === "dateOfMembership") {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      if (ex.response.data) {
        ...
        setSuccess({
          isSuccess: false,
          message: "Greska prilikom pravljenja naloga",
        });
    }
  }
      ...
      <form className="registerForm" onSubmit={(e) => handleSubmit(e)}>
        ...
        {formData.userRole === "editor" ? (
          <fieldset style={{ border: "none" }}>
            <label className="registerLabel">Naziv uloge:</label>
            <input
              className="registerInput"
              name="userRoleName"
              type="text"
        ...
        {formData.userRole === "none" ? (
          <fieldset style={{ border: "none" }}>
            <label className="registerLabel">Status:</label>
            <select
              className="registerInput"
              name="userStatus"
              onChange={handleChange}
